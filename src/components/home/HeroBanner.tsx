...
const HeroBanner = () => {
  ...
  return (
    <div className="relative h-[500px] md:h-[600px] overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center">
            <div className="max-w-xl text-white">
              ...
              <Button 
                size="lg" 
                className="bg-hospital-600 hover:bg-hospital-700 text-white animate-fade-in"
              >
      ...
      <button 
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 bg-white bg-opacity-30 hover:bg-opacity-50 rounded-full p-2 text-white"
        onClick={nextSlide}
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 w-2 rounded-full transition-all duration-300 ${
              index === currentSlide ? 'w-8 bg-white' : 'bg-white bg-opacity-50'
            }`}
