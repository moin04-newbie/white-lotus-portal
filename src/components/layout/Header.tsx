  ...
  return <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          {/* Mobile Menu Button */}
          {isMobile && <button onClick={toggleMenu} className="md:hidden text-gray-500 hover:text-hospital-600 focus:outline-none" aria-label={isMenuOpen ? 'Close menu' : 'Open menu'}>
